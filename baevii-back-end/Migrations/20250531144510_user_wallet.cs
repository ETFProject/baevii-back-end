...
{
    /// <inheritdoc />
    public partial class user_wallet : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WalletClient = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WalletClientType = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
